...
public class AssertUtils {
     ...
     */
    public static String notEmpty(String text, String errorMsgTemplate, Object... params) throws BizException {
     ...
     * @throws BizException 被检查字符串为空
     */
    public static String notEmpty(String text) throws BizException {
     ...
     */
    public static String notBlank(String text, String errorMsgTemplate, Object... params) throws BizException {
     ...
     * @throws BizException 被检查字符串为空白
     */
    public static String notBlank(String text) throws BizException {
     ...
     * @throws BizException if the object array is {@code null} or has no elements
     */
    public static Object[] notEmpty(Object[] array) throws BizException {
     ...
     * @throws BizException if the collection is {@code null} or has no elements
     */
    public static <T> Collection<T> notEmpty(Collection<T> collection) throws BizException {
     ...
     * @throws BizException if the map is {@code null} or has no entries
     */
    public static <K, V> Map<K, V> notEmpty(Map<K, V> map) throws BizException {
     ...
     * @param size 长度
     * @return 检查后的下标
     * @throws BizException 如果size < 0 抛出此异常
    ...
    public static int checkBetween(int value, int min, int max) {
        if (value < min || value > max) {
            throw new BizException(StrUtil.format("Length must be between {} and {}.", min, max));
        }
        return value;
    }
